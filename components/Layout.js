...
const SocialIcons = ({ size = 20 }) => (
  <div style={{ display: 'flex', gap: '20px', justifyContent: 'center' }}>
    <a href="https://www.instagram.com/monurkilic.kw" target="_blank" rel="noreferrer" style={{ color: '#bd1e24' }}>
    ...
    <a href="https://www.facebook.com/profile.php?id=61579458574677" target="_blank" rel="noreferrer" style={{ color: '#bd1e24' }}>
...
export default function Layout({ children }) {
  ...
  // Aktif sayfalar KW kırmızısı (#bd1e24), pasif sayfalar temiz bir gri/beyaz tonu alacak
  const getLinkColor = (path) => {
    if (path === '/') return router.pathname === '/' ? '#bd1e24' : '#cccccc';
    return router.pathname.startsWith(path) ? '#bd1e24' : '#cccccc';
  };
