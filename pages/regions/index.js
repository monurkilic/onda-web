...
export default function RegionsList({ regions }) {
  return (
    <>
      <Head>
        <title>Bölge Analizleri ONDA | Rasyonel Yatırım Rehberi</title>
        <meta name="description" content="İzmir ve Ankara'nın en değerli bölgelerine dair rasyonel veriler ve piyasa projeksiyonları." />
      </Head>

      <style dangerouslySetInnerHTML={{ __html: `
        .regions-container { max-width: 1200px; margin: 100px auto; padding: 0 20px; font-family: 'Inter', sans-serif; }
        .regions-title { color: #d4af37; font-size: 3rem; font-weight: 900; letter-spacing: 6px; text-transform: uppercase; text-align: center; margin-bottom: 20px; }
        .regions-subtitle { text-align: center; color: #fff; opacity: 0.7; margin-bottom: 80px; font-size: 1.1rem; letter-spacing: 1px; }
        ...
        .region-card:hover { border-color: #d4af37; transform: translateY(-10px); }
        ...
        .region-name { color: #d4af37; font-size: 1.4rem; font-weight: 900; letter-spacing: 1px; margin-bottom: 20px; text-transform: uppercase; }
        ...
        @media (max-width: 768px) { .regions-title { font-size: 2rem; } }
      `}} />

      <main className="regions-container">
        <h1 className="regions-title">BÖLGE ANALİZLERİ ONDA</h1>
