    ...
    <div style={{backgroundColor: '#0a192f', color: '#fff', minHeight: '100vh', fontFamily: 'serif', display: 'flex', flexDirection: 'column'}}>
      ...
      <main style={{flex: 1, padding: '40px 20px', maxWidth: '1100px', margin: '0 auto', width: '100%'}}>
        ...
        <div className="map-container" style={{height: '450px', width: '100%', borderRadius: '4px', overflow: 'hidden', border: '1px solid rgba(212,175,55,0.1)'}}>
          <iframe 
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d199967.36830588628!2d26.916174486307122!3d38.41732585970281!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14bbd862a7621491%3A0x6974b41958c24f9d!2zxLB6bWly!5e0!3m2!1str!2str!4v1711430000000!5m2!1str!2str" 
            width="100%" 
            height="100%" 
            style={{border:0}} 
            allowFullScreen="" 
