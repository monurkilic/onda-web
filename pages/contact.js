      ...
      <main style={{flex: 1, padding: '40px 20px', maxWidth: '1100px', margin: '0 auto', width: '100%'}}>
        ...
        <div className="contact-grid">
           <div>
             ...
             <p style={{color: '#ccc', lineHeight: '2', fontSize: '1rem'}}>
               İzmir - Ankara<br/>
               <strong>E-posta:</strong> m.onur.kilic@gmail.com<br/>
               <strong>Telefon:</strong> +90 532 646 69 09
             </p>
           </div>
        ...
        <div className="map-container" style={{height: '450px', width: '100%', borderRadius: '4px', overflow: 'hidden', border: '1px solid rgba(212,175,55,0.1)'}}>
          <iframe 
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d200000!2d27.1428!3d38.4237!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14bbd862a7621931%3A0x37a6210f607f0!2zxLB6bWly!5e0!3m2!1str!2str!4v1710000000000" 
            width="100%" 
            height="100%" 
            style={{border:0}} 
            allowFullScreen="" 
